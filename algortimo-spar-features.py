...
#		.getOrCreate()
	...
	data=CorrelationFeature(sc.textFile(sys.argv[2],5))
	...
	model.save(sc, "hdfs://master:9000/user/app/model-renato-DT-25.model")
	print 'model done'
	#to load the model
	...
	print 'metrics'
	tp=metrics.truePositiveRate(1)
	fp=metrics.falsePositiveRate(0)
